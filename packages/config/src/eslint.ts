...
export const eslintConfig = (extendConfig: IESLintConfig) => {
  ...
  return {
    ...
    extends: [
      ...
      'eslint:recommended',
      /** eslint-plugin-react */
      useReact ? 'plugin:react/recommended' : null,
      /** eslint-plugin-react-hooks */
      useReact ? 'plugin:react-hooks/recommended' : null,
    ...
    plugins: ['@typescript-eslint', useReact ? 'react' : null, useReact ? 'react-hooks' : null].filter(Boolean),
    settings: useReact
      ? {
          react: {
            version: 'detect',
